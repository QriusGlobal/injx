...
Use GitHub CLI commands to manage milestones:
...
gh milestone view <number>

# Edit milestone (description, due date, etc.)
gh milestone edit <number> --description "Updated description"
